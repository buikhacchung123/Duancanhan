function titleCase(str) {
  ...
  function fullDay(str) {
    if (str == 'Mon') str = 'Thứ hai';
    else if (str === 'Tue') str = 'Thứ 3';
    else if (str === 'Wed') str = 'Thứ tư';
    else if (str === 'Thu') str = 'Thứ năm';
    else if (str === 'Fri') str = 'Thứ sáu';
    else if (str === 'Sat') str = 'Thứ bảy';
    else str = 'Chủ nhật';
    return str;
  }
  ...
  $(function() {
    ...
    function getWeather(input) {
      ...
      requestWeather.done(function(data) {
        ...
        $tempNumber.html(toCelsius(Math.round(data.main.temp)));
        $description.html(titleCase(data.weather[0].description));
        $wind.html('Gió: ' + tokmh(data.wind.speed) + ' km/h');
        $humidity.html('Độ ẩm: ' + data.main.humidity + '%');
